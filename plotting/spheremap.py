...
# Full coordinate transforms are much slower, and the difference
# with the fast approximations are not important for this use.
...
class SphereMap:
    ...
    js_fname = "plotting/update_map.js"
    ...
    def update_js(self):
        ...
        """
        with open(self.js_fname, "r") as js_io:
            js_code = js_io.read()
